    ...
    return (
        <div className="min-h-screen bg-gray-100 flex items-center justify-center">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
                <h1 className="text-3xl font-bold text-center text-gray-700 mb-6">Login as Doctor</h1>
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            name="email"
                            id="email"
                            value={data.email}  // Bind to useForm's data.email
                            onChange={(e) => setData('email', e.target.value)} // Use setData to update email
                    ...
                    <div className="mb-6">
                        ...
                        <input
                            ...
                            name="password"
                            id="password"
                            value={data.password}  // Bind to useForm's data.password
                            onChange={(e) => setData('password', e.target.value)} // Use setData to update password
                            className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-600"
                            required
                        />
